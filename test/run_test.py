...
subprocess.run("python3 ../tape_specific-runner.py --spec-amino 50 --distance 50 --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_specific-runner.py --spec-amino 1 --distance 50 --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_specific-runner.py --spec-amino 3739 --distance 50 --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_general-runner.py --aa K --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_general-runner.py --aa M --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_general-runner.py --aa - --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_general-runner.py --aa KL --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_general-runner.py --aa MV --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
...
subprocess.run("python3 ../tape_general-runner.py --aa A- --motif NGG --loci test_loci.txt --cds test_cds.txt --reference-genome test_genome.txt --output test", shell=True, check=True)
